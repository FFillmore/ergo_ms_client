...
import BaseApexChart from '@/modules/bio/submodules/geobotany/components/charts/BaseApexChart.vue'
import { getShortElementTitle } from '@/modules/bio/js/bio-helpers'
